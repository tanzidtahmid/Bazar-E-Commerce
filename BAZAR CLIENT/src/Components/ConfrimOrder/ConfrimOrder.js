...
const ConfrimOrder = () => {
    ...
    return (
        <div className='grid row proceed-main-container'>
            {
                isTrue && <div className='position-absolute d-flex justify-content-center align-items-center flex-column w-100 h-100 ' style={{ zIndex: 1 }}>
                    <div className='bg-primary w-50 shadow p-5 rounded'>
            ...
            <div className='col-md-8 proceed-item '>
                <h3 className='mx-5 mt-2 px-3'>CheackOut Info</h3>
